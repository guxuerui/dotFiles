...
export ZSH="/Users/guxuerui/.oh-my-zsh"
...
# filter commit within a specifif time period
alias got='git log --pretty=format:"%h%x09%an%x09%ad%x09%s" | grep -E "\ 20:|\ 21:|\ 22:|\ 23:"'
